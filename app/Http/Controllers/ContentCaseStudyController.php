...
class ContentCaseStudyController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('CaseStudy.category.content',compact('breadcrumbs','id'));
    }

    public function store(Request $request, $id)
    {

        $this->repository->contentStore($request, $id);
    ...
    {
        $this->repository->contentUpdate($request, $id);
        return redirect()->route('case-study');
    }
    ...
    public function view_for_api($slug)
    {
        ...
        $data =$this->repository->contentEdit($case->id);
        ...
        $fixedLink[] = [
            'key' => 'canonical',
            'value' => $frontendUrl . '/case-studies/content-writing-case-studies/' . slugify($case->category) . '/' . $case->slug.'/'. $case->id,
        ];
