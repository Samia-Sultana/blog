            ...
            <ul class="nav nav-pills mb-2">
                ...
                <li class="nav-item ">
                    <a class="nav-link active" href="#">
                        ...
                        <span class="fw-bold">Update SEO</span>
                    </a>
                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <select class="select2 form-select" id="index_status" name="index_status">
                                    <option value="1" {{ $data[0]->index_status == 1 ? 'selected' : '' }}>Index</option>
                                    <option value="2" {{ $data[0]->index_status == 2 ? 'selected' : '' }}>No Index</option>
                                </select>
                            </div>
                            <!-- Meta Title -->
                            ...
                            <div class="col-12 col-sm-12 mb-1">
                                ...
                                <textarea class="form-control" id="meta_description" name="meta_description" placeholder="Meta Description"  data-msg="Please enter meta description">{{ $data[0]->meta_description }}</textarea>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">{{ $data[0]->post_links }}</h4>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card-body py-2 my-25" id="post-script-sections">
                                    ...
                                    <div class="post-script-template">
                                        @foreach($postScriptData as $post_script)
                                        <div class="row">
                                            <div class="col-12 col-sm-12 mb-1">
                                                <label class="form-label" for="type">Type</label>
                                                <input type="text" class="form-control" name="type[]" placeholder="Type" value="{{ $post_script->type }}" data-msg="Please enter type" />
                                            </div>
                                            <div class="col-12 col-sm-12 mb-1">
                                                <label class="form-label" for="script">Script</label>
                                                <textarea class="form-control" name="script[]" placeholder="Script"  data-msg="Please enter script">{{ $post_script->script }}</textarea>
                                            </div>
                                            <div class="col-12">
                                                <button type="button" class="btn btn-danger mt-1 me-1 remove" style="display: none;">Remove</button>
                                            </div>
