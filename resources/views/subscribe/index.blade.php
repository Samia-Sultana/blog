        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('subscribe') }}">
                    <div class="filter-section">
                        <div class="row filter-row">
                            ...
                            <div class="col-md-3 mb-1 d-flex align-items-center" style="margin-top: 25px;">
                                <button type="submit" class="btn btn-primary waves-effect waves-float waves-light">
                                    Filter
                                </button>
                                @if(request()->hasAny(['email', 'from_date', 'to_date']))
                ...
                <div class="d-flex justify-content-end" style="margin-top: -50px;">
                    <form method="POST" action="{{ route('subscribe.export') }}">
                        @csrf
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th>Email</th>
                            <th>
                                <a href="{{ route('subscribe', array_merge(request()->except('page'), [
                                    'sort_by' => 'created_at',
