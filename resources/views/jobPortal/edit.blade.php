    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body py-2 my-25">
                ...
                <!-- form -->
                <form class="validate-form pt-50" method="POST" action="{{ route('job.update', ['id' => $old->id]) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                            ...
                            <select required class="form-control" id="position_id" name="position_id" data-msg="Please select a job position">
                                ...
                                @foreach($positionLabels as $label)
                                    <option value="{{ $label->id }}"
                                        @if(old('position_id', isset($old) ? $old->position_id : null) == $label->id) selected @endif>
                                        {{ $label->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <input required type="text" class="form-control" id="job_type" name="job_type" placeholder="Enter job_type" value="{{ $old->job_type }}" data-msg="Please enter job_type" />
                        </div>
                        <div class="col-12 col-sm-6 mb-1">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <input required type="number" class="form-control" id="no_of_vacancy" name="no_of_vacancy" placeholder="Enter no_of_vacancy" value="{{ $old->no_of_vacancy }}" data-msg="Please enter no_of_vacancy" />
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <div id="educations-container">
                                <div class="educations-row" id="first-row">
                                    <input type="text" class="form-control" name="educations[]" value="{{json_decode($old->educations)[0]}}" placeholder="Enter employment status" data-msg="Please enter employment status" />


                                </div>

                                @foreach(array_slice(json_decode($old->educations),1) as $status)
                                <div class="d-flex educations-container">
                                    <input type="text" class="form-control mt-1" name="educations[]" value="{{ $status }}" placeholder="Enter employment status" data-msg="Please enter employment status" />
                                    <button type="button" class="btn btn-sm btn-primary mt-1 ms-1 remove-row-educations">Remove</button>
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <div id="experiences-container">
                                <div class="experiences-row" id="first-row">
                                    <input type="text" class="form-control" name="experiences[]" value="{{json_decode($old->experiences)[0]}}" placeholder="Enter employment status" data-msg="Please enter employment status" />


                                </div>

                                @foreach(array_slice(json_decode($old->experiences),1) as $status)
                                <div class="d-flex experiences-container">
                                    <input type="text" class="form-control mt-1" name="experiences[]" value="{{ $status }}" placeholder="Enter employment status" data-msg="Please enter employment status" />
                                    <button type="button" class="btn btn-sm btn-primary mt-1 ms-1 remove-row-experiences">Remove</button>
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <div id="employment_statuses-container">
                                ...
                                <div class="d-flex employment_statuses-container">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary mt-1 ms-1 remove-row-employment_statuses">Remove</button>
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <div id="responsibilities-container">
                                <div class="responsibilities-row" id="first-row">
                                    <input type="text" class="form-control" name="responsibilities[]" value="{{json_decode($old->responsibilities)[0]}}" placeholder="Enter employment status" data-msg="Please enter employment status" />


                                </div>

                                @foreach(array_slice(json_decode($old->responsibilities),1) as $status)
                                <div class="d-flex responsibilities-container">
                                    <input type="text" class="form-control mt-1" name="responsibilities[]" value="{{ $status }}" placeholder="Enter employment status" data-msg="Please enter employment status" />
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <div id="requirements-container">
                                <div class="requirements-row" id="first-row">
                                    <input type="text" class="form-control" name="requirements[]" value="{{json_decode($old->requirements)[0]}}" placeholder="Enter employment status" data-msg="Please enter employment status" />


                                </div>

                                @foreach(array_slice(json_decode($old->requirements),1) as $status)
                                <div class="d-flex requirements-container">
                                    <input type="text" class="form-control mt-1" name="requirements[]" value="{{ $status }}" placeholder="Enter employment status" data-msg="Please enter employment status" />
                                    <button type="button" class="btn btn-sm btn-primary mt-1 ms-1 remove-row">Remove</button>
                                </div>
                                @endforeach
                            </div>
                            <button type="button" id="add-more-requirements" class="btn btn-sm btn-primary mt-1">Add More</button>
                        </div>
                        ...
                        <!-- <div class="col-12 col-sm-6 mb-1 btn-group" role="group" aria-label="Basic radio toggle button group">
                            <input type="radio" class="btn-check" name="is_active" value="1" id="btnradio1" autocomplete="off" @if($old->is_active == 1) checked @endif>
                            <label class="btn btn-outline-primary" for="btnradio1">Active</label>

                            <input type="radio" class="btn-check" name="is_active" value="0" id="btnradio2" autocomplete="off" @if($old->is_active == 0) checked @endif>
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                                ...
                                @if($old->image)
                                    <div class="mb-2">
                                        <img id="preview" src="{{ asset($old->image) }}" alt="job Image" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                @endif
                            ...
                            {{-- <div class="col-12 col-sm-12 mb-1">
                                ...
                                <textarea name="description" class="form-control ckeditor" rows="2" placeholder="Enter blog description">{!! $old->description !!}</textarea>
                            </div> --}}
...
<script>
    ...
    document.addEventListener('click', function(e) {
        if (e.target && e.target.classList.contains('remove-row-experiences')) {
    ...
    function showRemoveButtons() {
        ...
        document.getElementById('first-row').querySelector('.remove-row-experiences').classList.add('d-none');
        if (rows.length === 1) {
            rows[0].querySelector('.remove-row-experiences').classList.add('d-none');
        } else {
            rows.forEach(function(row) {
                row.querySelector('.remove-row-experiences').classList.remove('d-none');
            });
        }
    }
    ...
    document.addEventListener('click', function(e) {
        if (e.target && e.target.classList.contains('remove-row-educations')) {
            var row = e.target.parentNode;
            var container = document.getElementById('educations-container');
            if (container.children.length > 1) {
                row.remove();
    ...
    function showRemoveButtons() {
        ...
        document.getElementById('first-row').querySelector('.remove-row-educations').classList.add('d-none');
        if (rows.length === 1) {
            rows[0].querySelector('.remove-row-educations').classList.add('d-none');
        } else {
            rows.forEach(function(row) {
                row.querySelector('.remove-row-educations').classList.remove('d-none');
            });
        }
    }
    ...
    document.addEventListener('click', function(e) {
        if (e.target && e.target.classList.contains('remove-row-employment_statuses')) {
            var row = e.target.parentNode;
            var container = document.getElementById('employment_statuses-container');
            if (container.children.length > 1) {
                row.remove();
    ...
    function showRemoveButtons() {
        ...
        document.getElementById('first-row').querySelector('.remove-row-employment_statuses').classList.add('d-none');
        if (rows.length === 1) {
            rows[0].querySelector('.remove-row-employment_statuses').classList.add('d-none');
        } else {
            rows.forEach(function(row) {
                row.querySelector('.remove-row-employment_statuses').classList.remove('d-none');
            });
        }
    }
