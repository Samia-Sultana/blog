                    ...
                    <form action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group">
                                <label for="page_title">Page Url</label>
                                <input type="text" class="form-control" id="page_url" name="page_url" placeholder="Enter Page Title">
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_10_content_1" placeholder="Image Url Link">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 3 - Best SEO Service Company In</label>
                                <input type="text" class="form-control" name="section_1_content_2" placeholder="Best SEO Service Company In">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 4 - Description</label>
                                <textarea name="section_1_content_3" class="form-control" placeholder="Description"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 5 - Monthly organic visitors</label>
                                <input type="text" class="form-control" name="section_1_content_4" placeholder="Monthly organic visitors">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 6 - SEO Case Studies</label>
                                <input type="text" class="form-control" name="section_1_content_5" placeholder="SEO Case Studies">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 7 - Ecommerce Transations</label>
                                <input type="text" class="form-control" name="section_1_content_6" placeholder="Ecommerce Transations">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 8 - Ecommerce Projects</label>
                                <input type="text" class="form-control" name="section_1_content_7" placeholder="Ecommerce Projects">
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_3_content_1" placeholder="Why is VISER X the Best SEO Agency in">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 2 - Description</label>
                                <textarea name="section_3_content_2" class="form-control" placeholder="Description"></textarea>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_4_content_1" placeholder="Our SEO Strength">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 2 - Industry Experts</label>
                                <textarea name="section_4_content_2" class="form-control" placeholder="Industry Experts"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 3 - Experienced</label>
                                <textarea name="section_4_content_3" class="form-control" placeholder="Experienced"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 4 - Dedicated Project Manager</label>
                                <textarea name="section_4_content_4" class="form-control" placeholder="Dedicated Project Manager"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 5 - Dedicated Writers</label>
                                <textarea name="section_4_content_5" class="form-control" placeholder="Dedicated Writers"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 6 - SEO Reporting</label>
                                <textarea name="section_4_content_6" class="form-control" placeholder="SEO Reporting"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 7 - Maximize ROI</label>
                                <textarea name="section_4_content_7" class="form-control" placeholder="Maximize ROI"></textarea>
                            </div>
                        </fieldset>
                        ...
                        {{-- <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_5_content_1" placeholder="Trusted">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 2 - Description</label>
                                <textarea name="section_5_content_2" class="form-control" placeholder="Description"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 3 - Location</label>
                                <input type="text" class="form-control" name="section_5_content_3" placeholder="Location">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 4 - Phone</label>
                                <input type="text" class="form-control" name="section_5_content_4" placeholder="Phone">
                            </div>
                        </fieldset> --}}
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <button type="button" class="btn btn-primary" onclick="addCaseStudy()">Add Another Case Study</button>
                        </fieldset>
                        ...
                        {{-- <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_7_content_1" placeholder="Section 7 Content 1">
                            </div>
                            <div class="form-group mb-2">
                                <label>Section 7 Content 2</label>
                                <input type="text" class="form-control" name="section_7_content_2" placeholder="Section 7 Content 2">
                            </div>
                            <div class="form-group mb-2">
                                <label>Section 7 Content 3</label>
                                <input type="text" class="form-control" name="section_7_content_3" placeholder="Section 7 Content 3">
                            </div>
                            <div class="form-group mb-2">
                                <label>Section 7 Content 4</label>
                                <input type="text" class="form-control" name="section_7_content_4" placeholder="Section 7 Content 4">
                            </div>
                            <div class="form-group mb-2">
                                <label>Section 7 Content 5</label>
                                <input type="text" class="form-control" name="section_7_content_5" placeholder="Section 7 Content 5">
                            </div>
                            <div class="form-group mb-2">
                                <label>Section 7 Content 6</label>
                                <input type="text" class="form-control" name="section_7_content_6" placeholder="Section 7 Content 6">
                            </div>
                            <div class="form-group mb-2">
                                <label>Section 7 Content 7</label>
                                <input type="text" class="form-control" name="section_7_content_7" placeholder="Section 7 Content 7">
                            </div>
                            <div class="form-group mb-2">
                                <label>Section 7 Content 8</label>
                                <input type="text" class="form-control" name="section_7_content_8" placeholder="Section 7 Content 8">
                            </div>
                        </fieldset> --}}
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_8_content_2" placeholder="Earn more revenue with NYC SEO services">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 3 - Description</label>
                                <textarea name="section_8_content_3" class="form-control" placeholder="Description"></textarea>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_9_content_2" placeholder="Get Started with">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 3</label>
                                <textarea name="section_9_content_3" class="form-control" placeholder="Description"></textarea>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="section_2_content_1" placeholder="Get Start With">
                            </div>
                        </fieldset>
                        ...
                        {{-- <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="section_10_content_1" placeholder="Section 10 Content 1">
                            </div>
                        </fieldset> --}}
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="section_11_content_1_faq" placeholder="FAQ Question">
                            </div>
                            <div class="form-group mb-2">
                                <label>Content 1 FAQ Answer</label>
                                <textarea name="section_11_content_2_faq" class="form-control" placeholder="Enter FAQ Question description"></textarea>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="border p-3 rounded mb-4">
                            ...
                            <div class="form-group mb-2">
                                <label>Meta</label>
                                <textarea name="meta" class="form-control" placeholder="Enter meta description"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Link</label>
                                <textarea name="link" class="form-control" placeholder="Enter link description"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label>Script</label>
                                <textarea name="script" class="form-control" placeholder="Enter link description"></textarea>
                            </div>
                        </fieldset>
...
<script>
    ...
    function removeCaseStudy(button) {
        // Don't allow removal if there's only one section left
        const sections = document.querySelectorAll('.case-study-section');
        if (sections.length <= 1) {
            alert('You need to have at least one case study section.');
            return;
        }
