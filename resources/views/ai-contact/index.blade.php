...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('ai-page-contacts') }}">
                ...
                <div class="d-flex justify-content-end" style="margin-top: -50px;">
                    <form method="POST" action="{{ route('ai-page-contacts.export') }}">
                        @csrf
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th>Message</th>
                            <th>
                                <a href="{{ route('ai-page-contacts', array_merge(request()->except('page'), [
                                    'sort_by' => 'created_at',
