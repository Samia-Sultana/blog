...
@section('title', 'Create SEO Case Study')
    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body py-2 my-25">
                ...
                <!-- form -->
                <form class="validate-form pt-50" method="POST" action="{{ route('case.seo.store', $id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description " name="header_description" id="header_description" rows="3"></textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="sec_1_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="sec_1_desc" rows="3"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="sec_2_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description " name="sec_2_desc" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-6 mb-1">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="sec_3_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description " name="sec_3_desc" rows="2"></textarea>
                        </div>
                    </div>
                        ...
                        <div class="content-section">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 mb-1">
                                    ...
                                    <textarea required name="solution_description[]" class="form-control ckeditor" rows="2" placeholder="Enter blog description"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 mb-1">
                    ...
                    <div id="image-sections">
                        <div class="image-section">
                            ...
                            <div class="col-12 col-sm-6 mb-1">
                                ...
                                <input required type="text" id="sec_3_image" name="image_alt[]" class="form-control" placeholder="Enter alt">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="sec_result_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description " name="sec_result_desc" rows="2"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="sec_ranking_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description " name="sec_ranking_desc" rows="2"></textarea>
                        </div>
                    </div>
