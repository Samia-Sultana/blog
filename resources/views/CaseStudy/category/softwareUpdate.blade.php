...
@section('title', 'Update Software Case Study')
    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body py-2 my-25">
                ...
                <!-- form -->
                <form class="validate-form pt-50" method="POST" action="{{ route('case.software.update', $old->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input required type="text" value="{{ $old->featured_image_alt }}" class="form-control" id="featured_image_alt" name="featured_image_alt" placeholder="Enter image alt" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="po_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="po_desc" rows="3">
                                {{ $old->po_desc }}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="challenge_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="challenge_desc" rows="3"> {{ $old->challenge_desc }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="problem_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="problem_desc" rows="3"> {{ $old->problem_desc }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            @if($old->middle_1st_image)
                            <div class="mb-2" id="middle_1st_image_preview_container"  >
                                <img id="middle_1st_image_preview" src="{{ asset($old->middle_1st_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" value="{{ $old->middle_1st_image_alt }}" class="form-control mt-1" id="middle_1st_image_alt" name="middle_1st_image_alt" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="middle_2nd_image">Second Image<span class="text-danger">*</span></label>
                           
                            @if($old->middle_2nd_image)
                            <div class="mb-2" id="middle_2nd_image_preview_container"  >
                                <img id="middle_2nd_image_preview" src="{{ asset($old->middle_2nd_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" value="{{ $old->middle_2nd_image_alt }}" type="text" class="form-control mt-1" id="middle_2nd_image_alt" name="middle_2nd_image_alt" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="middle_3rd_image">Third Image<span class="text-danger">*</span></label>
                           @if($old->middle_3rd_image)
                            <div class="mb-2" id="middle_3rd_image_preview_container"  >
                                <img id="middle_3rd_image_preview" src="{{ asset($old->middle_3rd_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required  type="text" value="{{ $old->middle_3rd_image_alt }}" class="form-control mt-1" id="middle_3rd_image_alt" name="middle_3rd_image_alt" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="middle_4th_image">Fourth Image<span class="text-danger">*</span></label>
                           @if($old->middle_4th_image)
                            <div class="mb-2" id="middle_4th_image_preview_container"  >
                                <img id="middle_4th_image_preview" src="{{ asset($old->middle_4th_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" value="{{ $old->middle_4th_image_alt }}" class="form-control mt-1" id="middle_4th_image_alt" name="middle_4th_image_alt" placeholder="Enter image alt" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="workflow_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="workflow_desc" rows="3">{{ $old->workflow_desc }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="solution_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="solution_desc" rows="3">{{ $old->solution_desc }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 mb-1">
                           ...
                           @if($old->bottom_1st_image)
                            <div class="mb-2" id="bottom_1st_image_preview_container"  >
                                <img id="bottom_1st_image_preview" src="{{ asset($old->bottom_1st_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" value="{{ $old->bottom_1st_image_alt }}" class="form-control mt-1" id="bottom_1st_image_alt" name="bottom_1st_image_alt" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="bottom_2nd_image">Second Image<span class="text-danger">*</span></label>
                           @if($old->bottom_2nd_image)
                            <div class="mb-2" id="bottom_2nd_image_preview_container"  >
                                <img id="bottom_2nd_image_preview" src="{{ asset($old->bottom_2nd_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" class="form-control mt-1" id="bottom_2nd_image_alt"  name="bottom_2nd_image_alt" value="{{ $old->bottom_2nd_image_alt }}" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="bottom_3rd_image">Third Image<span class="text-danger">*</span></label>
                           @if($old->bottom_3rd_image)
                            <div class="mb-2" id="bottom_3rd_image_preview_container"  >
                                <img id="bottom_3rd_image_preview" src="{{ asset($old->bottom_3rd_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" class="form-control mt-1" id="bottom_3rd_image_alt"  name="bottom_3rd_image_alt" value="{{ $old->bottom_3rd_image_alt }}" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="bottom_4th_image">Fourth Image<span class="text-danger">*</span></label>
                            @if($old->bottom_4th_image)
                            <div class="mb-2" id="bottom_4th_image_preview_container"  >
                                <img id="bottom_4th_image_preview" src="{{ asset($old->bottom_4th_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" value="{{ $old->bottom_4th_image_alt }}" class="form-control mt-1" id="bottom_4th_image_alt" name="bottom_4th_image_alt" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="bottom_5th_image">Fifth Image<span class="text-danger">*</span></label>
                           @if($old->bottom_5th_image)
                            <div class="mb-2" id="bottom_5th_image_preview_container"  >
                                <img id="bottom_5th_image_preview" src="{{ asset($old->bottom_5th_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" value="{{ $old->bottom_5th_image_alt }}" class="form-control mt-1" id="bottom_5th_image_alt" name="bottom_5th_image_alt" placeholder="Enter image alt" />
                        </div>

                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="bottom_6th_image">Sixth Image<span class="text-danger">*</span></label>
                           @if($old->bottom_6th_image)
                            <div class="mb-2" id="bottom_6th_image_preview_container"  >
                                <img id="bottom_6th_image_preview" src="{{ asset($old->bottom_6th_image) }}" alt="Featured Image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                            ...
                            <input required type="text" value="{{ $old->bottom_6th_image_alt }}" class="form-control mt-1" id="bottom_6th_image_alt" name="bottom_6th_image_alt" placeholder="Enter image alt" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="conclusion_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="conclusion_desc" rows="3"> {{ $old->conclusion_desc }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 mb-1">
                            ...
                            <textarea class="form-control" id="meta_description" name="meta_description" placeholder="Meta Description" value="{{ $old->meta_description }}" data-msg="Please enter meta description"> {{ $old->meta_description }}</textarea>
                        </div>
                    </div>
