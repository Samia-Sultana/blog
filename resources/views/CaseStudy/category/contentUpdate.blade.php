...
@section('title', 'Update Content Case Study')
    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body py-2 my-25">
                ...
                <!-- form -->
                <form class="validate-form pt-50" method="POST" action="{{ route('case.content.update', $old->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="challenge_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="challenge_desc" rows="3">
                                {{ $old->challenge_desc}}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="helped_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="helped_desc" rows="3">
                                {{ $old->helped_desc}}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            @if($old->problem_image)
                                <div class="mb-2" id="preview_container_problem" >
                                    <img id="preview_problem" src="{{ asset($old->problem_image) }}" alt="problem_image" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            @endif
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="problem_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description" name="problem_desc" rows="3">
                                {{ $old->problem_desc}}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            @if($old->challenge_2_image)
                            <div class="mb-2" id="preview_container_challenge_2" >
                                <img id="preview_challenge_2" src="{{ asset($old->challenge_2_image) }}" alt="challenge_2_image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="challenge_2_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description " name="challenge_2_desc" rows="2">
                                {{ $old->challenge_2_desc}}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            @if($old->result_image)
                            <div class="mb-2" id="preview_container_result" >
                                <img id="preview_result" src="{{ asset($old->result_image) }}" alt="result_image" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                            @endif
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <textarea required id="result_desc" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter sort description " name="result_desc" rows="2">
                                {{ $old->result_desc}}
                            </textarea>
                        </div>
                    </div>
