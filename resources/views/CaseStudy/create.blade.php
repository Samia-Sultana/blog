    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body py-2 my-25">
                ...
                <!-- form -->
                <form class="validate-form pt-50" method="POST" action="{{ route('case.store') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="title">Title <span class="text-danger">*</span></label>
                            <input required type="text" class="form-control" id="title" name="title" placeholder="Enter title ( length will be 50 - 52 characters )" value="{{ old('title') }}" data-msg="Please enter title" />
                        </div>
                        <div class="col-12 col-sm-6 mb-1">
                        ...
                        <div class="col-md-6 mb-1">
                            ...
                            <textarea class="form-control" id="challenge" name="challenge" rows="3" placeholder="Enter challenge">{{ old('challenge') }}</textarea>
                            @error('challenge')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-1">
                            ...
                            <textarea class="form-control" id="solution" name="solution" rows="3" placeholder="Enter solution">{{ old('solution') }}</textarea>
                            @error('solution')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-1">
                            ...
                            <textarea class="form-control" id="results" name="results" rows="3" placeholder="Enter result">{{ old('result') }}</textarea>
                            @error('results')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
