    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body py-2 my-25">
                ...
                <!-- form -->
                <form class="validate-form pt-50" method="POST" action="{{ route('seo.update', ['id' => $old->id]) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-5 mb-1">
                            ...
                            <img id="preview1" src="{{ asset($old['image_1st_section']) }}" alt="1st Section Image Preview" class="img-thumbnail mt-2" style="max-width: 200px; {{ $old['image_1st_section'] ? 'display: block;' : 'display: none;' }}">
                        </div>

                        <div class="col-12 col-sm-1 d-flex flex-column">
                            <label class="form-label">1st Section Active</label>
                            <input class="form-check-input" type="checkbox" name="section_1st_is_active" {{ $old['section_1st_is_active'] ? 'checked' : '' }} id="flexCheckDefault">
                        </div>
                        ...
                        <div class="col-12 col-sm-1 d-flex flex-column">
                            <label class="form-label">2nd Section Active</label>
                            <input class="form-check-input" type="checkbox" name="section_2nd_is_active" {{ $old['section_2nd_is_active'] ? 'checked' : '' }} id="flexCheckDefault">
                        </div>
                        ...
                        <div class="col-12 col-sm-5 mb-1">
                            ...
                            <img id="preview3" src="{{ asset($old['section_3rd_image']) }}" alt="1st Section Image Preview" class="img-thumbnail mt-2" style="max-width: 200px; {{ $old['section_3rd_image'] ? 'display: block;' : 'display: none;' }}">

                        </div>

                        <div class="col-12 col-sm-1 d-flex flex-column">
                            <label class="form-label">3rd Section Active</label>
                            <input class="form-check-input" type="checkbox" name="section_3rd_is_active" {{ $old['section_3rd_is_active'] ? 'checked' : '' }} id="flexCheckDefault">
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <img id="previewCase1" src="{{ asset($old['case_study_1st_image']) }}" alt="1st Section Image Preview" class="img-thumbnail mt-2" style="max-width: 200px; {{ $old['case_study_1st_image'] ? 'display: block;' : 'display: none;' }}">
                        ...
                        <div class="col-12 col-sm-5 mb-1">
                            ...
                            <img id="previewCase2" src="{{ asset($old['case_study_2nd_image']) }}" alt="1st Section Image Preview" class="img-thumbnail mt-2" style="max-width: 200px; {{ $old['case_study_2nd_image'] ? 'display: block;' : 'display: none;' }}">

                        </div>

                        <div class="col-12 col-sm-1 d-flex flex-column">
                            <label class="form-label">Case Study Active</label>
                            <input class="form-check-input" type="checkbox" name="case_stydy_section_is_active" {{ $old['case_stydy_section_is_active'] ? 'checked' : '' }} id="flexCheckDefault">
                        </div>
                        ...
                        <div class="col-md-6 mb-1">
                            ...
                            <select class="select2 form-select" id="index_status" name="index_status">
                                ...
                                <option value="2" {{ $old['index_status'] == 2 ? 'selected' : '' }}>No Index</option>
                            </select>
                        </div>
