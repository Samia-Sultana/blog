...
@section('title', 'Seo Service In All Countries')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <form method="GET" action="{{ route('seo-service') }}">
                        <!-- @csrf -->
                    ...
                    <a href="{{ route('seo.create') }}" class="btn btn-outline-primary">Add Page</a>
                </div>
            </div>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <a href="{{ route('seo-service', array_merge(request()->except('page'), [
                                    'sort_by' => 'created_at',
                    ...
                    <tbody>
                        @foreach ($data as $seoServiceData)
                        <tr>
                            ...
                            <td>
                               <li>Created at : {{ \Carbon\Carbon::parse($seoServiceData->created_at)->format('d M Y') }}</li>
                              <li>Updated at : {{ \Carbon\Carbon::parse($seoServiceData->updated_at)->format('d M Y H:ia') }}</li>
                            </td>

                            <td class="text-center">
                                <input type="checkbox" class="item-checkbox" {{ $seoServiceData->is_published ? 'checked' : ''}} data-id="{{ $seoServiceData->id }}">

                            </td>
                            <td>
                                <div class="d-flex">
                                    <a class="" href="{{ route('seo.edit', ['id' => $seoServiceData->id]) }}">
